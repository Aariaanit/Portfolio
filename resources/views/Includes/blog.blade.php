...
<div class="blog-header"> Blogs</span>
    ...
    <div class="blog-content">
         <div class="blogs">
             <a href="#">
             <div class="img">
                <img src="{{ asset('assets/images/post-one.jpg') }}" alt="blog-one">
         ...
         <div class="blogs">
            <a href="#">
            <div class="img">
                <img src="{{ asset('assets/images/post-two.jpg') }}" alt="blog-two">
        ...
        <div class="blogs">
            <a href="#">
            <div class="img">
                <img src="{{ asset('assets/images/post-three.jpg') }}" alt="blog-three">
        ...
        <div class="blogs">
            <a href="#">
            <div class="img">
                <img src="{{ asset('assets/images/post-four.jpg') }}" alt="blog-four">
        ...
        <div class="blogs">
            <a href="#">
            <div class="img">
                <img src="{{ asset('assets/images/post-five.jpg') }}" alt="blog-five">
        ...
        <div class="blogs">
            <a href="#">
            <div class="img">
                <img src="{{ asset('assets/images/post-six.jpg') }}" alt="blog-six">
       ...
       <div class="footer">
        <div class="footer-text">
            <img src="{{ asset('assets/images/copyright.png') }}" alt="copyright-img" class="images" height="14px"> Willy Wonkas
        </div>
       </div>
<!--copyright-section-->
</div>