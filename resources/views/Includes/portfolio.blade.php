     ...
     <div id="portfolio-content">
         <div class="portfolio portfolio-first">
             <div class="portfolio-image">
                <img src="{{ asset('assets/images/portfolio-first.jpg') }}" alt="portfolio-first">
             </div>
         ...
         <div class="portfolio portfolio-second">
            <div class="portfolio-image">
                <img src="{{ asset('assets/images/portfolio-second.jpg') }}" alt="portfolio-second">
            </div>
            <div class="portfolio-text">
                <h2>Web Designing</h2>
        ...
        <div class="portfolio portfolio-third">
            <div class="portfolio-image">
                <img src="{{ asset('assets/images/portfolio-third.jpg') }}" alt="portfolio-third">
            </div>
            <div class="portfolio-text">
                <h2>UI Designing</h2>
        ...
        <div class="portfolio portfolio-fourth">
            <div class=" portfolio-image">
                <img src="{{ asset('assets/images/portfolio-fourth.jpg') }}" alt="portfolio-fourth">
            </div>
            <div class="portfolio-text">
                <h2>Wow Graphics</h2>
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ad ut optio repellat cupiditate
