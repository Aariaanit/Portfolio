<div id="about">
    ...
    <!--about picture-->
    <div class="about-img">
        <img src="{{ asset('assets/images/about.jpg') }}" alt="Your Image">
    </div>
    </div>
    ...
    <!--services content-->
            <div class="services-content">
                   <div class="service-one service wow">
                       ...
                       <img src="{{ asset('assets/images/coding.png') }}" alt="service-one">
                       </div>
                   ...
                   <div class="service-two service wow">
                       <div class="service-img">
                       <img src="{{ asset('assets/images/instagram.png') }}" alt="service-two">
                       </div>
                       <div class="service-description">
                        <h2>Social Media</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod quibusdam possimus</p>
                   ...
                   <div class="service-three service wow">
                    <div class="service-img">
                       <img src="{{ asset('assets/images/bulb.png') }}" alt="service-three">
                    </div>
                    <div class="service-description">
